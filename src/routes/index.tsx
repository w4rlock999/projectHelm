...
function Home() {
  ...
  return (
    <div className={cn('helm-home', `theme-${theme}`)}>
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col px-6 pt-8 pb-40">
        ...
        <main className="flex flex-1 flex-col py-10">
          ...
          <section
            className={cn(glass, 'flex flex-1 flex-col rounded-[2rem] px-7 py-7 sm:px-9 sm:py-8')}
          >
            {captainOpen ? (
              <CaptainPanel />
            ) : (
              <>
                <div className="flex flex-wrap items-start justify-between gap-5">
                  <h1 className="text-3xl leading-[1.05] font-semibold tracking-tight text-[var(--warm-ink)] sm:text-4xl">
                    Agents
                    <span className="block font-normal text-[var(--warm-ink-soft)]">
                      at your helm
                    </span>
                  </h1>
                ...
                <div className="mt-8">
                  {error ? (
                    ...
                    <p className={cn(monoMeta, 'text-xs text-[var(--warm-ink-faint)]')}>
                      Loading fleet…
                    </p>
                  ) : visible.length === 0 ? (
...
function Clock() {
  ...
  return (
    <div
      className={cn(monoMeta, 'text-right text-[0.6rem] leading-tight text-[var(--warm-ink-soft)]')}
    >
