...
export type McpServerView = RouterOutputs['mcp']['list'][number];
export type AgentMcpServerView = RouterOutputs['mcp']['forAgent'][number];
...
export type RemoteCheck = RouterOutputs['remotes']['check'];
